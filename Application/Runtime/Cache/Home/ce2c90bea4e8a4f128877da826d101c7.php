		...
		<div class="header">
			...
			<div class="inner">
				...
				<div class="nav">
					...
					<a href="/proj_car/index.php/home/about/index" class="nav-item"><i class="icon icon-about"></i>关于我们</a>
				</div>
			</div>
		</div>
		<div class="banner">
...
<div class="side">
	<div class="menu">
		...
		<div class="bd">
			<ul>
				<li><a href="/proj_car/index.php/about/index">公司简介</a></li>
				<li><a href="/proj_car/index.php/about/qualification">公司资质</a></li>
				<li><a href="/proj_car/index.php/about/jzairport">九寨沟机场</a></li>
				<li class="select"><a href="/proj_car/index.php/about/hyairport">红原机场</a></li>
			</ul>
		</div>
	</div>
</div>
<div class="main">
	<div class="content">
		<div class="hd">红原机场</div>
		<div class="bd">红原机场</div>
	</div>
</div>
</div>
</div>
