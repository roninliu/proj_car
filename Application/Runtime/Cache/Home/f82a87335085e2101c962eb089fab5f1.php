		...
		<div class="bd">
			<ul class="newslist">
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dataItem): $mod = ($i % 2 );++$i;?><li>
						...
						<a href="/proj_car/index.php/travel/getcontent?menu=<?php echo ($dataItem["parent"]); ?>&sub=<?php echo ($current["id"]); ?>&page=<?php echo ($dataItem["id"]); ?>" class="title"><?php echo ($dataItem["title"]); ?></a>
